"""
Source: https://github.com/wetliu/energy_ood/blob/master/utils/display_results.py
"""
import numpy as np
...
def print_measures(auroc, aupr, fpr, method_name='Ours', recall_level=recall_level_default):
    ...
    # print('AUROC: \t\t\t{:.2f}'.format(100 * auroc))
    # print('AUPR:  \t\t\t{:.2f}'.format(100 * aupr))
    print(f"Metric: {method_name} || FPR{int(100 * recall_level)}: {100*fpr:.2f} || AUROC: {100*auroc:.2f} || AUPR: {100*aupr:.2f}")
